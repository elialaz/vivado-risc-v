...
workspace/patch-hdl-done:
	...
	if [ -s patches/cva6.patch ] ; then cd generators/cva6 && ( git apply -R --check ../../patches/cva6.patch 2>/dev/null || git apply ../../patches/cva6.patch ) ; fi
